<?php
// varianta pred nadaljevanjem s sklopom 3.2. razvoj CRUD (SELECT, INSERT, UPDATE, DELETE, JOIN, WHERE), 
// kjer je v uvodu 1. koraka predvidena zamenjava celotne spodnje kode z novo ki jo je Gem predlagal
